...
module.exports.bootstrap = async function () {
  ...
  await User.createEach([
    { emailAddress: 'admin@example.com', fullName: 'tealz', isSuperAdmin: true, password: await sails.helpers.passwords.hashPassword('demofinder') },
  ]);
  await Event.createEach([
    {
      ...
      title: 'Demo gegen rechts',
      description: 'Demo gegen rechts!',
      organizedBy: 'Hand in Hand',
      url: 'https://gemeinsam-hand-in-hand.org/',
      imgUrl: 'https://gemeinsam-hand-in-hand.org/wp-content/uploads/2024/01/brandmauer_illus.png',
    },
    {
